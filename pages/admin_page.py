...
class AdminPage():
    ...
    def navigate_to_add_owner_button(self):
        self.driver.find_element(By.XPATH,"//div[@class='action_buttons']/button[@id='add_owner_input']").click()
        time.sleep(1)
    ...
    def activate_owner(self,name):
        ...
        time.sleep(1)
        self.driver.find_element(By.XPATH," //table/tbody/tr/td[text() = '"+name+"']//following-sibling::td/form/button[text()='Activate']").click()
        time.sleep(2)